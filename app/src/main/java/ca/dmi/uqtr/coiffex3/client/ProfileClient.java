...
public class ProfileClient extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        textNom =(EditText) view.findViewById(R.id.nom_profil_client);
        textEmail =(EditText) view.findViewById(R.id.email_profil_client);
        textNumber =(EditText) view.findViewById(R.id.numero_profile_client);
        editAdresse =(EditText) view.findViewById(R.id.edit_address_profile_client);
        editImageProfil =(ImageView) view.findViewById(R.id.photo_profil_client);
        btnSave =(Button) view.findViewById(R.id.button_enregister);
